using UnityEngine;
using static MPH.MatrixOperations;
...
class ActorNet {
    ...
    public float[,] Forward(float[,] s, float b, out float[,] alp){
        Profiler.BeginSample("ActorNet:Forward");    
    ...
    public void Backward(float[,] s, float[,] a, float[,] olp, float[] adv, float b, float clip_param, float max_grad_norm) {
        Profiler.BeginSample("ActorNet:Backward");  
        float[,] z1 = Add(Dot(s, w1), b1);
        float[,] h1 = Relu(z1);
        float[,] z2 = Add(Dot(h1, w2), b2);
        ...
        t++;
        Adam(ref w1, dw1, m1, v1, batch_size, beta1, beta2, eps, lr, t);
        Adam(ref w2, dw2, m2, v2, batch_size, beta1, beta2, eps, lr, t);
        Adam(ref w3, dw3, m3, v3, batch_size, beta1, beta2, eps, lr, t);
        Adam(ref b1, db1, mb1, vb1, batch_size, beta1, beta2, eps, lr, t);
        Adam(ref b2, db2, mb2, vb2, batch_size, beta1, beta2, eps, lr, t);
        Adam(ref b3, db3, mb3, vb3, batch_size, beta1, beta2, eps, lr, t);
